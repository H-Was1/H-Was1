...
[![My Skills](https://skillicons.dev/icons?i=react,nextjs,vue,nuxt,js,ts,docker,kubernetes,aws,tailwind,materialui,elysia,bun,express,nodejs,mongodb,postgresql,sqlite,redis,prisma,rust,actix,tauri,electron,selenium,nginx,linux,graphql,arduino)](https://skillicons.dev)
