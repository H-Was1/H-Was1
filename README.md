...
[![My Skills](https://skillicons.dev/icons?i=react,nextjs,js,ts,docker,kubernetes,aws,tailwind,materialui,express,nodejs,mongodb,postgresql,sqlite,redis,prisma,rust,tauri,electron,selenium,nginx,linux)](https://skillicons.dev)
