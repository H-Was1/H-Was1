...
[![My Skills](https://skillicons.dev/icons?i=react,nextjs,prometheus,grafana,js,ts,docker,kubernetes,aws,tailwind,kafka,elysia,bun,express,nest,nodejs,mongodb,postgresql,sqlite,redis,wasm,rust,actix,tauri,electron,selenium,nginx,linux,graphql,rabbitmq,arduino,cloudflare,  )](https://skillicons.dev)
